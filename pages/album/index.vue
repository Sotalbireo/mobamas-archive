  ...
  <div>
    ...
    <TransitionRoot :show="summary">
      ...
      <TransitionChild
        ...
        leave-to="opacity-0"
        class="inset-x-auto bottom-0 z-40 fixed w-full sm:w-frame overflow-hidden pt-2 px-3 pb-6-safe"
      >
        <div
        ...
        >
          <div class="overflow-hidden h-52 rounded-xl">
            <img src="@/assets/asuka.jpg" class="rounded-xl">
          </div>
...
appTitle.value = 'アルバム'
const { list: thumbList } = useThumbnail()

const summary = ref(false)

const thumbs = await Promise.all(
  thumbList.value!.map(t => $fetch<string>(`/api/v1/images/thumb/${t}`))
